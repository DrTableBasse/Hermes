...
remote_path = "/home/ubuntu/auth_middleware_debug.py"
...
rc, out = run("docker cp /home/ubuntu/auth_middleware_debug.py hermes-v2-web-api-1:/app/middleware/auth_middleware.py 2>&1")
print("docker cp:", out, "exit:", rc)

# Restart container to pick up new code
rc, out = run("cd Hermes-v2 && docker compose restart web-api 2>&1", timeout=30)
print("restart:", out[-500:])
