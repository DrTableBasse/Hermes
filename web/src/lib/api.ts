...
export interface UserStats {
  ...
  stats:   { total_messages: number; voice_hours: number; warn_count: number; msg_rank: number; voice_rank: number; xp_total: number; current_level: number; current_streak: number; max_streak: number; xp_multiplier: number; bump_count: number; bump_rank: number; msg_current_streak: number; msg_max_streak: number }
