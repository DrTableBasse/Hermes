            ...
            <div className="container mx-auto px-4">
              {isSafeDiscordUrl && (
                <div className="bg-primary/5 border border-primary/20 rounded-xl p-4 flex flex-col sm:flex-row items-center justify-between gap-4 mb-6">
                  <div>
                    <p className="font-semibold text-foreground">🎮 Rejoins SaucisseLand</p>
                    <p className="text-sm text-muted-foreground mt-1">Une communauté active · XP · Quêtes · Classements</p>
                  </div>
                  <a
                    href={discordInviteUrl}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="bg-discord text-white font-bold py-2 px-4 rounded-lg text-sm flex items-center gap-2 shrink-0"
                  >
